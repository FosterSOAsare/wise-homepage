const getPaidStyle = {
	...
	getPaid__image: { order: { xs: "1", md: "2" }, display: "flex", justifyContent: "center", alignItems: "center", margin: 0, overflow: "hidden !important", width: "100%" },
